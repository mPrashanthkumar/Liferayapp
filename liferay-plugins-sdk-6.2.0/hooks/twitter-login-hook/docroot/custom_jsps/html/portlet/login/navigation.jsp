...
<%@ page import="org.scribe.builder.api.TwitterApi.SSL" %>
...
<c:if test="<%= showAnonymousIcon || showCreateAccountIcon || showForgotPasswordIcon || showOpenIdIcon || showSignInIcon %>">
	<div class="navigation">
		<liferay-ui:icon-list>
			...
			OAuthService service = new ServiceBuilder().provider(org.scribe.builder.api.TwitterApi.SSL.class).apiKey(twitterApiKey).apiSecret(twitterApiSecret).callback(callbackURL).build();
