...
import com.cloud.tags.service.CartsLocalService;
...
/**
 * Provides the base implementation for the carts local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.cloud.tags.service.impl.CartsLocalServiceImpl}.
 * </p>
 *
 ...
 * @generated
 */
public abstract class CartsLocalServiceBaseImpl extends BaseLocalServiceImpl
	implements CartsLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.cloud.tags.service.CartsLocalServiceUtil} to access the carts local service.
	 */
	...
	@Override
	public Carts addCarts(Carts carts) throws SystemException {
		carts.setNew(true);

		return cartsPersistence.update(carts);
	}
	 ...
	 */
	@Override
	public Carts createCarts(long cartId) {
		return cartsPersistence.create(cartId);
	}
	...
	@Override
	public Carts deleteCarts(long cartId)
		throws PortalException, SystemException {
		return cartsPersistence.remove(cartId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public Carts deleteCarts(Carts carts) throws SystemException {
		return cartsPersistence.remove(carts);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(Carts.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return cartsPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end)
		throws SystemException {
		return cartsPersistence.findWithDynamicQuery(dynamicQuery, start, end);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return cartsPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery,
		...
		return cartsPersistence.countWithDynamicQuery(dynamicQuery, projection);
	}

	@Override
	public Carts fetchCarts(long cartId) throws SystemException {
		return cartsPersistence.fetchByPrimaryKey(cartId);
	}
	 ...
	 */
	@Override
	public Carts getCarts(long cartId) throws PortalException, SystemException {
		return cartsPersistence.findByPrimaryKey(cartId);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return cartsPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<Carts> getCartses(int start, int end) throws SystemException {
		return cartsPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getCartsesCount() throws SystemException {
		return cartsPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public Carts updateCarts(Carts carts) throws SystemException {
		return cartsPersistence.update(carts);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.cloud.tags.model.Carts",
			cartsLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"com.cloud.tags.model.Carts");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = cartsPersistence.getDataSource();
	...
	private CartsLocalServiceClpInvoker _clpInvoker = new CartsLocalServiceClpInvoker();
}