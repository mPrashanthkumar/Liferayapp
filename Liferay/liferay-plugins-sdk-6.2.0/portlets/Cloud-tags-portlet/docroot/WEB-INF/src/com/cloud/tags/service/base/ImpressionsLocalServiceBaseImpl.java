...
import com.cloud.tags.service.ImpressionsLocalService;
...
/**
 * Provides the base implementation for the impressions local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.cloud.tags.service.impl.ImpressionsLocalServiceImpl}.
 * </p>
 *
 ...
 * @generated
 */
public abstract class ImpressionsLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements ImpressionsLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.cloud.tags.service.ImpressionsLocalServiceUtil} to access the impressions local service.
	 */
	...
	@Override
	public Impressions addImpressions(Impressions impressions)
		throws SystemException {
		impressions.setNew(true);

		return impressionsPersistence.update(impressions);
	}
	 ...
	 */
	@Override
	public Impressions createImpressions(long recId) {
		return impressionsPersistence.create(recId);
	}
	...
	@Override
	public Impressions deleteImpressions(long recId)
		throws PortalException, SystemException {
		return impressionsPersistence.remove(recId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public Impressions deleteImpressions(Impressions impressions)
		throws SystemException {
		return impressionsPersistence.remove(impressions);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(Impressions.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return impressionsPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end)
		throws SystemException {
		return impressionsPersistence.findWithDynamicQuery(dynamicQuery, start,
			end);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return impressionsPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public Impressions fetchImpressions(long recId) throws SystemException {
		return impressionsPersistence.fetchByPrimaryKey(recId);
	}
	 ...
	 */
	@Override
	public Impressions getImpressions(long recId)
		throws PortalException, SystemException {
		return impressionsPersistence.findByPrimaryKey(recId);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return impressionsPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<Impressions> getImpressionses(int start, int end)
		throws SystemException {
		return impressionsPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getImpressionsesCount() throws SystemException {
		return impressionsPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public Impressions updateImpressions(Impressions impressions)
		throws SystemException {
		return impressionsPersistence.update(impressions);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.cloud.tags.model.Impressions",
			impressionsLocalService);
	}
	...
	private ImpressionsLocalServiceClpInvoker _clpInvoker = new ImpressionsLocalServiceClpInvoker();
}