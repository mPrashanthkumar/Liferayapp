...
/**
 * Provides the local service interface for Carts. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Mohammed Zaheer
 * @see CartsLocalServiceUtil
...
public interface CartsLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link CartsLocalServiceUtil} to access the carts local service. Add custom service methods to {@link com.cloud.tags.service.impl.CartsLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
